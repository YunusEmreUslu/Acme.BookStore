...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p febe8daf-3e0a-4b4b-a391-aa9866120b48
```

> `febe8daf-3e0a-4b4b-a391-aa9866120b48` is the password of the certificate, you can change it to any password you want.
